import { AnimatedImageBackground } from '@/components/Animated/AnimatedImageBackground';
import { Icon, IconProps } from '@/components/common/Icon';
import { COLLAPSED_HEIGHT, EXPANDED_HEIGHT } from '@/components/layout/CollapsibleHeader/useCollapsibleHeader';
import { useAppTheme } from '@/theme';
import { lightType, semiBoldType } from '@/theme/fontConfig';
import React, { JSX, useCallback } from 'react';
import { Animated, ImageSourcePropType, View, ViewProps } from 'react-native';
...
const interpolate = (value: number, inputRange: Range, outputRange: Range): number => {
    ...
    return (
        ...
        >
            <AnimatedImageBackground
                ...
                imageStyle={{
                    resizeMode: 'cover',
                    opacity: scaleByHeaderHeight(0.3, 0.2),
                }}
                style={{ flex: 1 }}
            >
