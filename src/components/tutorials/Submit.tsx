...
export const SubmitTutorial = props => {
    ...
    const slides = [
        (
            <>
                <H4 font={'semiBold'} style={{ textAlign: 'center', color: theme.colors.onPrimary[50] }}>{'Submitting Your Swing'}</H4>
                <H7 font={'light'} style={{ textAlign: 'center', marginTop: spaces.small, marginBottom: spaces.medium, color: theme.colors.onPrimary[50] }}>{`When you are ready to submit your swing, click on the golfer images to upload Face-On and Down-the-Line videos.`}</H7>
        ...
        (
            <>
                <H4 font={'semiBold'} style={{ textAlign: 'center', color: theme.colors.onPrimary[50] }}>{'Using the Camera'}</H4>
                <H7 font={'light'} style={{ textAlign: 'center', marginTop: spaces.small, marginBottom: spaces.medium, color: theme.colors.onPrimary[50] }}>{`Press the Record button to start recording your swing.`}</H7>
                <RecordButton recording={false} onPress={() => {}} style={{alignSelf: 'center', marginTop: spaces.large}}/>
                <H7 font={'light'} style={{ textAlign: 'center', marginTop: spaces.xLarge, marginBottom: spaces.xLarge, color: theme.colors.onPrimary[50] }}>{`You can adjust your settings for recording length and delay by clicking the settings icon.`}</H7>
