...
class Record extends Component {
    ...
    _startRecording(){
        ...
        const options = { maxFileSize: 9.5*1024*1024, maxDuration: 10, quality: RNCamera.Constants.VideoQuality['480p'] };
            ...
            <View style={{backgroundColor: colors.backgroundGrey, flex: 1, flexDirection: 'column', alignItems: 'stretch'}}>
                ...
                <Header
                    outerContainerStyles={{ 
                        ...
                        height: 70-24,//Platform.OS === 'ios' ? 70 :  70 - 24, 
                        padding: 10,//15,//Platform.OS === 'ios' ? 15 : 10,
                        position: 'absolute',
                        borderBottomWidth: 0,
                ...
                <View style={{
                    ...
                    >
                        <Text style={{color: colors.white, textAlign: 'left'}}>Cancel</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        onPress={()=>{
