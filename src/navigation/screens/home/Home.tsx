...
export const Home = withNavigation((props) => {
    ...
    return (
        <View style={styles.container}>
            ...
            >
                <View style={{ flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: 8, marginHorizontal: 16 }}>
                ...
                />
                <View style={{ flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', marginTop: 32, marginBottom: 8, marginHorizontal: 16 }}>
                ...
                <ListItem
                    ...
                    title={<Typography.Body font={'regular'} style={{ marginLeft: 16 }}>Individual Lessons</Typography.Body>}
                    rightTitle={'3 Left'}
                    leftIcon={{
                        name: 'golf-course',
                        color: '#231f61',
                ...
                <ListItem
                    ...
                    chevron={true}
                    onPress={() => { }}
                    title={<Typography.Body font={'regular'} style={{ marginLeft: 16 }}>Activate Unlimited</Typography.Body>}
                    rightTitle={'0 Left'}
                    leftIcon={{
                ...
                <ListItem
                    ...
                    title={<Typography.Body font={'regular'} style={{ marginLeft: 16 }}>Order More</Typography.Body>}
                    leftIcon={{
                        name: 'shopping-cart',
                        color: '#231f61',
                    }}
                />
                <View style={{ flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: 8, marginHorizontal: 16, marginTop: 32 }}>
